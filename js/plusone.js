...
(function() {
    ...
    var Ja = function(a, b, c) {
        ...
        L = function(a, b, c) {
            b && 0 < b.length && (b = Ka(b), c && 0 < c.length && (b += "___" + Ka(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = v(Ia, "_p", w()), v(b, c, w())[a] = (new Date).getTime(), Ja(a, "_p", c))
        },
        Ka = function(a) {
    ...
    var Ma = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        Ta = function(a, b, c, d) {
            ...
            b = k;
            c = b.match(Qa);
            (d = b.match(Ra)) && 1 === d.length && Sa.test(b) && c && 1 === c.length || N("failed sanity: " + a);
            return k
        },
        Wa = function(a, b, c, d) {
            a = Ua(a);
            Oa.test(c) || N("invalid_callback");
            b = Va(b);
            d = d && d.length ? Va(d) : null;
            var e = function(a) {
        ...
        Sa = /^https?:\/\/[a-z0-9_.-]+\.google\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/,
        Ra = /\/cb=/g,
        Qa = /\/\//g,
        Ya = function() {
            var a = I(r.href);
    ...
    La.m = function(a, b, c, d) {
        ...
        return "https://apis.google.com" + Wa(a, b, c, d)
    };
    var Za = decodeURI("%73cript"),
        $a = function(a, b) {
        ...
        bb = function(a) {
            "loading" != p.readyState ? ab(a) : p.write("<" + Za + ' src="' + encodeURI(a) + '"></' + Za + ">")
        },
        ab = function(a) {
            var b = p.createElement(Za);
            b.setAttribute("src", a);
            b.async = "true";
            (a = p.getElementsByTagName(Za)[0]) ? a.parentNode.insertBefore(b, a): (p.head || p.body || p.documentElement).appendChild(b)
        },
        cb = function(a, b) {
            var c = b && b._c;
            if (c)
            ...
            if (x.length) {
                ...
                if (x.length) {
                    ...
                    k.push.apply(k,
                        x);
                    L("ml0", x, u);
                    b.sync || n.___gapisync ? bb(a) : ab(a)
                } else F[G](ea)
            } else t(x) && d && d()
        };
    var db = function(a, b) {
    ...
    var P = function(a) {
        ...
        R = function(a, b) {
            if (b)
                for (var c in b) b.hasOwnProperty(c) && (a[c] && b[c] && "object" === typeof a[c] && "object" === typeof b[c] && !gb(a[c]) && !gb(b[c]) ? R(a[c], b[c]) : b[c] && "object" === typeof b[c] ? (a[c] = gb(b[c]) ? [] : {}, R(a[c], b[c])) : a[c] = b[c])
        },
        hb = function(a) {
            if (a && !/^\s+$/.test(a)) {
                for (; 0 ==
        ...
        ib = function(a) {
            ...
            for (e = 0; e < d.length; ++e) d[e].getAttribute("gapi_processed") || (d[e].setAttribute("gapi_processed", !0), (f = d[e]) ? (g = f.nodeType, f = 3 == g || 4 == g ? f.nodeValue : f.textContent || f.innerText || f.innerHTML || "") : f = void 0, (f = hb(f)) && b.push(f));
            a && (d = {}, R(d, a), c.push(d));
            d = P("cd");
            a = 0;
            ...
            if (!mb) {
                ...
                if (window.self !== window.top) {
                    var a = document.location.toString(),
                        e;
                    for (e in lb) 0 < lb[e] && (b = D(a, e, "")) && (nb[e] = b)
                }
                mb = !0
            }
            e = w();
    ...
    var wb;
    var xb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/u\/(\d)\//,
        yb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/b\/(\d{10,})\//,
        zb = function(a) {
            ...
            null == b && (a = a || window.location.href, b = D(a, "authuser") || null, null == b && (b = (b = a.match(xb)) ? b[1] : null));
            return null == b ? null : String(b)
        },
        Ab = function(a) {
            var b = S("googleapis.config/sessionDelegate");
            null == b && (b = (a = (a || window.location.href).match(yb)) ? a[1] : null);
            return null == b ? null : String(b)
        };
    var U = function() {
        this.g = -1
    ...
    (function() {
        ...
        V.J = function(a, c, d) {
            ...
            return U.prototype[c].apply(a, e)
        }
    })();
    ...
    var Db = n.crypto,
        ...
        Kb = function(a) {
            ...
            Hb = Hb * b % Ib;
            0 < Fb && ++Gb == Fb && E("mousemove", Kb, "remove", "de")
        },
        Lb = function(a) {
            var b = new Cb;
        ...
        Eb = !!Db &&
        "function" == typeof Db.getRandomValues;
    Eb || (Ib = 1E6 * (screen.width * screen.width + screen.height), Jb = Lb(p.cookie + "|" + p.location + "|" + (new Date).getTime() + "|" + Math.random()), Fb = S("random/maxObserveMousemove") || 0, 0 != Fb && E("mousemove", Kb, "add", "at"));
    var Mb = function() {
            var a = Hb,
                a = a + parseInt(Jb.substr(0, 20), 16);
            Jb = Lb(Jb);
            return a / (Ib + Math.pow(16, 20))
        },
        Nb = function() {
            var a = new n.Uint32Array(1);
            Db.getRandomValues(a);
            return Number("0." + a[0])
        };
    var Ob = function() {
            var a = H.onl;
        ...
        Pb = function(a, b) {
            var c = b.onload;
            return "function" === typeof c ? (Ob().a(a, c), c) : null
        },
        Qb = function(a) {
    ...
    var Sb = {
        ...
        Wb = function(a, b, c, d, e) {
            ...
            for (var h in c) a = c[h], "style" === h && "object" === typeof a ? A(a, f.style) : Tb[h] || f.setAttribute(h, String(a));
    ...
    var bc = {
                ...
                switch (typeof a) {
                    ...
                    case "object":
                        ...
                        if ("number" ===
                            ...
                            d = a.length;
                            for (c = 0; c < d; c += 1) b.push(cc(a[c]) || "null");
                            return "[" + b.join(",") + "]"
                        }
                        for (c in a) !/___$/.test(c) && y(a, c) && "string" === typeof c && (d = cc(a[c])) && b.push(cc(c) + ":" + d);
                        return "{" + b.join(",") + "}"
                }
                return ""
            }
        ...
        ec = !1;
    try {
        ec = !!window.JSON && '["a"]' === window.JSON.stringify(["a"]) && "a" === window.JSON.parse('["a"]')[0]
    } catch (a) {}
    var fc = function(a) {
            try {
        ...
        gc = ec ? window.JSON.stringify : cc,
        hc = ec ? fc : dc;
    var ic = function(a) {
            var b;
        ...
        jc = function(a) {
            ...
            for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
                ...
                if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = ic(e)) && null != e.match(/^https?:\/\/[\w\-\_\.]+/i)) return e
            }
    ...
    var kc = {
        ...
        nc = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "),
        oc = v(H, "WI", w()),
        pc = function(a, b, c) {
            var d, e;
            d = {};
            ...
            for (var g in kc) d[g] = g + "/" + (b[g] || kc[g]) + "/";
            d = va(p, e.replace(Yb,
                ac(d)));
            g = "iframes/" + a + "/params/";
            f = {};
            ...
            lc[a] || (f.origin = window.location.origin || window.location.protocol + "//" + window.location.host);
            f.exp = S(g + "exp");
            if (g = S(g + "location"))
            ...
            switch (a) {
                ...
                case "follow":
                    ...
                    g = (g = "string" == typeof g ? g : void 0) ? ic(g) : jc(e);
                    f.url = g;
                    delete f.href;
                    break;
                case "plusone":
            ...
            delete f.rd;
            for (var h in kc) f[h] && delete f[h];
        ...
        sc = function(a) {
            ...
            a = a.style;
            (c = rc(a && a.height)) && (b.height = String(c));
            (a = rc(a && a.width)) && (b.width = String(a));
            return b
        },
        rc = function(a) {
            var b = void 0;
            ...
            ub(function(b) {
                if (a !== b.id && 4 != b.state && "share" != b.type) {
                    ...
                    if (f) {
                        var g = pc(d, b, 0);
                        g ? (f = f.parentNode,
                            e.replace(/\#.*/, "").replace(/(\?|&)ic=1/, "") !== g.replace(/\#.*/, "").replace(/(\?|&)ic=1/, "") && (b.dontclear = !0, b.rd = !0, b.ri = !0, b.type = d, tc(f, b), (d = T[f.lastChild.id]) && (d.oid = c), vb(c, 4))) : delete T[c]
                    } else delete T[c]
                }
            })
        };
    var W, X, Y, vc, wc, xc = /(?:^|\s)g-((\S)*)(?:$|\s)/,
        yc = {
            plusone: !0,
            autocomplete: !0,
            profile: !0,
        ...
        zc = function(a, b, c, d) {
            ...
            for (f = 0; f < e.length; f++) {
                ...
                h.getAttribute("data-gapiscan") ? k = null : (0 == l.indexOf("g:") ?
                    m = l.substr(2) : (h = (h = String(h.className || h.getAttribute("class"))) && xc.exec(h)) && (m = h[1]), k = !m || !(W[m] || X[m] || Y[m]) || k && m !== k ? null : m);
                k && (yc[k] || 0 == g.nodeName.toLowerCase().indexOf("g:") || 0 != z(sc(g)).length) && (g.setAttribute("data-gapiscan", !0), v(c, k, []).push(g))
            }
            if (b)
                for (var q in c)
                    for (b = c[q], d = 0; d < b.length; d++) b[d].setAttribute("data-onload", !0);
            for (var u in c) vc.push(u);
            K("ps1", !0);
            if ((q = vc.join(":")) || a) try {
                C.load(q, a)
            } catch (x) {
            ...
            if (Bc(wc || {}))
                for (var t in c) {
                    ...
                    d = [];
                    for (t in c)
                        for (a = c[t], u = 0, b = a.length; u < b; u++) e = a[u], Dc(t, e, sc(e), d, b);
                    Ec(q, d)
                }
        },
        Fc = function(a) {
    ...
    var Cc = function(a, b) {
            ...
            switch (Jc(b, a, f)) {
                ...
                case 1:
                    ...
                    if (b.parentNode) {
                        ...
                        g.siteElement =
                            l;
                        l.id || (b = l, v(oc, a, 0), f = "___" + a + "_" + oc[a]++, b.id = f);
                        b = w();
                        b[">type"] = a;
                        A(c, b);
                        f = h;
                        ...
                        e = b = f;
                        Xb.test(b) && (e = S("iframes/" + e.substring(1) + "/url"), B(!!e, "Unknown iframe url config for - " + b));
                        f = va(p, e.replace(Yb, $b));
                        b = c.ownerDocument || p;
                        l = 0;
                        do e = h.id || ["I", Ub++, "_", (new Date).getTime()].join(""); while (b.getElementById(e) && 5 > ++l);
                        ...
                        t.pfname = u;
                        A(t, q);
                        (t = D(f, "rpctoken") || l.rpctoken || m.rpctoken) || (t = q.rpctoken = h.rpctoken || String(Math.round(1E8 * (Eb ? Nb() : Mb()))));
                        h.rpctoken = t;
                        t = b.location.href;
                        q = w();
                        (x = D(t, "_bsh", H.bsh)) &&
                        ...
                        if ((h || {}).allowPost && 2E3 < f.length) {
                            ...
                            m.src = "";
                            m["data-postorigin"] = f;
                            f = Wb(b, c, m, e); - 1 != navigator.userAgent.indexOf("WebKit") && (k = f.contentWindow.document, k.open(), m = k.createElement("div"), q = {}, t = e + "_inner", q.name = t, q.src = "", q.style = "display:none", Wb(b, m, q, t, h));
        ...
        tc = function(a, b) {
            ...
            if (d) {
                ...
                (f = !!e.ri) && delete e.ri;
                var g = [];
                Dc(c, d, e, g, 0, f, void 0);
                Ec(c, g)
            } else rb("string" === "gapi." + c + ".render: missing element " + typeof a ? a : "")
        };
    v(C, "platform", {}).go = Ac;
    var Bc = function(a) {
    ...
    M.push(["platform", function(a, b, c) {
        ...
        b && vc.push(b);
        Lc(Gc, a);
        Lc(Hc, c._c.annotation);
        Lc(Ic, c._c.bimodal);
        kb();
        ib();
        if ("explicit" != S("parsetags")) {
            Da(a);
            pb(ob()) && !S("disableRealtimeCallback") && tb();
            var d;
    ...
    var Nc = /^\{h\:'/,
        ...
        Qc = function(a, b) {
            a = String(a);
            if (Nc.test(a)) return !0;
            var c = !1;
            Oc.test(a) && (c = !0, a = a.substr(2));
            if (!/^\{/.test(a)) return !1;
            var d = hc(a);
            if (!d) return !1;
            var e = d.f;
            if (d.s && e && -1 != ga.call(b, e)) {
                if ("_renderstart" === d.s || d.s === Pc + "/" + e + "::_renderstart") {
                    var f = d.a && d.a[c ? 0 : 1],
    ...
    var Sc = function(a, b) {
        ...
        Tc = /^[-+/_=.:|%&a-zA-Z0-9@]*$/,
        Uc = /^[A-Z_][A-Z0-9_]{0,63}$/;
    Sc.prototype.write = function(a, b) {
        if (!Uc.test(this.O)) throw "Invalid cookie name";
        if (!Tc.test(a)) throw "Invalid cookie value";
        var c = this.O + "=" + a;
    ...
    var Vc = function(a) {
        ...
        Wc = {};
    Vc.prototype.write = function(a) {
        Wc[this.X] = a;
        return !0
    };
    Vc.iterate = function(a) {
        for (var b in Wc) Wc.hasOwnProperty(b) && a(b, Wc[b])
    };
    var Xc = "https:" === window.location.protocol,
        Yc = Xc || "http:" === window.location.protocol ? Sc : Vc,
        Zc = function(a) {
            var b = a.substr(1),
                c = "",
        ...
        $c = function() {
            var a, b = null;
            Yc.iterate(function(c, d) {
                if (0 === c.indexOf("G_AUTHUSER_")) {
                    var e = Zc(c.substring(11));
    ...
    var ad = function(a) {
            ...
            if (-1 == d) return b;
            var e = Zc(a.substr(d + 1));
            if (null == e) return b;
            a = a.substring(0, d);
            if ("_" !== a.charAt(0)) return b;
            d = "E" === c && e.c;
            return !d && ("U" !== c || e.c) || d && !Xc ? b : {
                N: !0,
                c: d,
                ca: a.substr(1),
                domain: e.domain,
    ...
    var fd = null,
        ...
        tb = function() {
            H.oa = !0;
            var a = dd();
            (a = a && a.A) && jb("googleapis.config/sessionIndex", a);
            fd || (fd = v(H, "ss", new Z(gd)));
            a = fd;
            a.T && a.T()
        },
        gd = function() {
            ...
            O("auth", {
                callback: function() {
                    ...
                    a.checkSessionState(e, function(b) {
                        ...
                        if (k = k != b) jb("isLoggedIn", b), tb(), uc(), b || ((b = a.signOut) ? b() : (b = a.setToken) && b(null));
                        b =
                            ob();
                        ...
                        jb("savedUserState", c);
                        (k || h) && pb(b) && !S("disableRealtimeCallback") && a._pimf(b, !0)
                    })
                }
            });
            return !0
...
gapi.load("plusone", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.es.K0KxqAKqMDY.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCMV9o4g_qdx5YtUT7CJEPWOjj-Rwg",
            "u": "https://apis.google.com/js/plusone.js",
            "hee": true,
            "fp": "a358219942d80dfe713a3fc5dfafd0a6ef66af41",
            "dpo": false
        },
        "platform": ["additnow", "backdrop", "blogger", "comments", "commentcount", "community", "family_creation", "follow", "hangout", "page", "partnersbadge", "person", "playemm", "playreview", "plus", "plusone", "post", "savetodrive", "savetowallet", "shortlists", "signin2", "udc_webconsentflow", "visibility", "youtube", "ytsubscribe", "zoomableimage", "sharetoclassroom", "donation"],
        "fp": "a358219942d80dfe713a3fc5dfafd0a6ef66af41",
