(function() {
    ...
    function n(a) {
        ...
        window._gat || (a = document.createElement("script"), a.type = "text/javascript", a.async = !0, a.src = ("https:" == document.location.protocol ? "https://ssl" : "http://www") + ".#", c = document.getElementsByTagName("script")[0], c.parentNode.insertBefore(a, c));
        p(this, this.l, this);
